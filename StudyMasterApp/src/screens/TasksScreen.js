  ...
  const renderTask = ({ item }) => (
    <View style={[styles.taskCard, { borderLeftColor: PRIORITY_COLORS[item.priority] }]}>
      <TouchableOpacity 
        ...
        onPress={() => navigation.navigate('Study', { task: item })}
      >
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modal}>
            ...
            <View style={styles.priorityRow}>
              ...
              <View style={styles.priorityBtns}>
                {['low', 'medium', 'high'].map(p => (
                  <TouchableOpacity
                    key={p}
                    style={[styles.priorityBtn, { borderColor: PRIORITY_COLORS[p] }, newTask.priority === p && { backgroundColor: PRIORITY_COLORS[p] }]}
            ...
            <View style={styles.modalActions}>
              <TouchableOpacity style={styles.cancelBtn} onPress={() => { setShowModal(false); setEditingTask(null); }}>
